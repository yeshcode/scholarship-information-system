...
<div class="p-6">  
    ...
    <!-- Add Year Level Button (Upper Right, Enhanced Design) -->
    <div class="flex justify-end mb-6">
        <a href="<?php echo e(route('admin.year-levels.create')); ?>" class="inline-flex items-center bg-black text-black hover:bg-gray-800 font-bold py-3 px-6 rounded-lg shadow-md transition duration-200">
            <span class="mr-2">+</span> Add Year Level
        </a>
    </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $yearLevels ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $yearLevel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition duration-150 even:bg-gray-25">
                            <td class="border border-gray-300 px-3 py-2 text-gray-800"><?php echo e($yearLevel->year_level_name); ?></td>
                            <td class="border border-gray-300 px-3 py-2 space-x-2">
                                <a href="<?php echo e(route('admin.year-levels.edit', $yearLevel->id)); ?>" class="inline-flex items-center bg-blue-500 hover:bg-blue-600 text-black font-medium py-1 px-3 rounded shadow transition duration-200 text-sm">
                                    <span class="mr-1">✏️</span> Edit
                                </a>
                                <a href="<?php echo e(route('admin.year-levels.delete', $yearLevel->id)); ?>" class="inline-flex items-center bg-red-500 hover:bg-red-600 text-black font-medium py-1 px-3 rounded shadow transition duration-200 text-sm">
                    ...
                    <?php if(empty($yearLevels)): ?>
                        <tr>
                            <td colspan="2" class="px-3 py-4 text-gray-500 text-center">No year levels found. <a href="<?php echo e(route('admin.year-levels.create')); ?>" class="text-blue-500 underline hover:text-blue-700">Add one now</a>.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
