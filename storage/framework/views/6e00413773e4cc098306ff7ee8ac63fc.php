...
<div class="report-header">
    <div class="logo left">
        <img src="<?php echo e($bisuSeal); ?>" alt="BISU Seal">
    </div>
    ...
    <div class="logo right">
        <img src="<?php echo e($bagong); ?>" alt="Bagong Pilipinas">
        <img class="tuv" src="<?php echo e($tuv); ?>" alt="TUV">
    </div>
</div>

<hr class="hr-line"><?php /**PATH C:\xampp\htdocs\scholarship-information\resources\views/coordinator/reports/partials/a4-header.blade.php ENDPATH**/ ?>