...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('admin.enrollments.enroll-students')); ?>" class="btn btn-bisu-primary shadow-sm">
                Enroll Students
            </a>
            <a href="<?php echo e(route('admin.enrollments.records')); ?>" class="btn btn-bisu-primary shadow-sm">
                Records
            </a>
        </div>
    </div>
