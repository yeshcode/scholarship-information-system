...
<form method="POST" action="<?php echo e(route('admin.enrollments.store')); ?>">
    ...
    <select name="section_id" class="border p-2 w-full mb-4" required>
        ...
        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($section->id); ?>"><?php echo e($section->section_name); ?> (<?php echo e($section->course->course_name ?? 'N/A'); ?> - <?php echo e($section->yearLevel->year_level_name ?? 'N/A'); ?>)</option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
