...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('landing')); ?>">
            <img src="<?php echo e(asset('images/scholarship_logo.jpg')); ?>" alt="Logo">
            <div>
        ...
        <div class="ms-auto">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-login text-white">
                Login
            </a>
        </div>
    </div>
        ...
        <div id="landingCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <img src="<?php echo e(asset('images/scholarship-landing1.jpg')); ?>" class="d-block w-100" alt="Slide 1">
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/landing2.png')); ?>" class="d-block w-100" alt="Slide 2">
                    <div class="carousel-caption text-start">
                ...
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/scholarship-landing2.jpg')); ?>" class="d-block w-100" alt="Slide 3">
                    <div class="carousel-caption text-start">
            ...
            <div class="card stat-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="display-6 fw-bold" style="color:var(--brand-blue)">
                        <?php echo e(number_format($scholarsCount)); ?>
        ...
        <div class="col-md-4">
            <div class="card stat-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="display-6 fw-bold" style="color:var(--brand-blue)">
                        <?php echo e(number_format($scholarships->count())); ?>
        ...
        <div class="col-md-4">
            <div class="card stat-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="display-6 fw-bold" style="color:var(--brand-blue)">
                        <?php echo e(number_format($announcements->count())); ?>
                            ...
                            <?php $__currentLoopData = $scholarships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="list-group-item">
                                    ...
                                    <?php if(!empty($s->description)): ?>
                                        <div class="mt-2">
                                            <?php echo e(\Illuminate\Support\Str::limit($s->description, 160)); ?>
                        ...
                        <div class="list-group">
                            <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex justify-content-between align-items-start gap-2">
                                        <div class="fw-bold">
                                            <?php echo e($a->title ?? 'Announcement'); ?>
