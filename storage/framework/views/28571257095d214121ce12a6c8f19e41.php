...
<div class="p-6">  
    ...
    <div class="flex justify-end mb-6">
        <a href="<?php echo e(route('admin.colleges.create')); ?>" class="inline-flex items-center bg-black text-black hover:bg-gray-800 font-bold py-3 px-6 rounded-lg shadow-md transition duration-200">
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="overflow-x-auto max-h-[calc(100vh-200px)] overflow-y-auto">  
            <table class="table-auto w-full border-collapse text-center min-w-full">
                <thead class=" text-black sticky top-0">  
                ...
                <tbody>
                    <?php $__currentLoopData = $colleges ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $college): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition duration-150 even:bg-gray-25">
                            <td class="border border-gray-300 px-3 py-2 text-gray-800"><?php echo e($college->college_name); ?></td>
                            <td class="border border-gray-300 px-3 py-2 space-x-2">
                                <a href="<?php echo e(route('admin.colleges.edit', $college->id)); ?>" class="inline-flex items-center bg-blue-500 hover:bg-blue-600 text-black font-medium py-1 px-3 rounded shadow transition duration-200 text-sm">
                                    <span class="mr-1">✏️</span> Edit
                                </a>
                                <a href="<?php echo e(route('admin.colleges.delete', $college->id)); ?>" class="inline-flex items-center bg-red-500 hover:bg-red-600 text-black font-medium py-1 px-3 rounded shadow transition duration-200 text-sm">
                    ...
                    <?php if(empty($colleges)): ?>
                        <tr>
                            <td colspan="2" class="px-3 py-4 text-gray-500 text-center">No colleges found. <a href="<?php echo e(route('admin.colleges.create')); ?>" class="text-blue-500 underline hover:text-blue-700">Add one now</a>.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
