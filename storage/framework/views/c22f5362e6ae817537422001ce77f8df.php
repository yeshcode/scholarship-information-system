...
<div class="p-6">  
    ...
    <div class="flex justify-end mb-6">
        <a href="<?php echo e(route('admin.user-types.create')); ?>" class="inline-flex items-center bg-black text-black hover:bg-gray-800 font-bold py-3 px-6 rounded-lg shadow-md transition duration-200">
                ...
                <tbody>
                    <?php $__currentLoopData = $userTypes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 transition duration-150 even:bg-gray-25">
                            <td class="border border-gray-300 px-3 py-2 text-gray-800"><?php echo e($userType->id); ?></td>
                            <td class="border border-gray-300 px-3 py-2 text-gray-800"><?php echo e($userType->name); ?></td>
                            <td class="border border-gray-300 px-3 py-2 text-gray-800"><?php echo e($userType->description ?? 'N/A'); ?></td>
                            <td class="border border-gray-300 px-3 py-2 space-x-2">
                                <a href="<?php echo e(route('admin.user-types.edit', $userType->id)); ?>" class="inline-flex items-center bg-blue-500 hover:bg-blue-600 text-black font-medium py-1 px-3 rounded shadow transition duration-200 text-sm">
                                    <span class="mr-1">✏️</span> Edit
                                </a>
                                <a href="<?php echo e(route('admin.user-types.delete', $userType->id)); ?>" class="inline-flex items-center bg-red-500 hover:bg-red-600 text-black font-medium py-1 px-3 rounded shadow transition duration-200 text-sm">
                    ...
                    <?php if(empty($userTypes)): ?>
                        <tr>
                            <td colspan="4" class="px-3 py-4 text-gray-500 text-center">No user types found. <a href="<?php echo e(route('admin.user-types.create')); ?>" class="text-blue-500 underline hover:text-blue-700">Add one now</a>.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
