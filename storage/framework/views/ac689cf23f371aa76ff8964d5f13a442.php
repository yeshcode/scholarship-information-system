            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="mt-3 d-flex flex-wrap gap-2">
                        ...
                        <a class="btn btn-outline-secondary btn-sm"
                            href="<?php echo e(route('coordinator.reports.summary-of-scholarships.docx', ['semester_id' => $activeSemesterId])); ?>">
                                Download DOCX
                        </a>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body p-3 p-md-4">
                    ...
                    <div class="mt-3 d-flex flex-wrap gap-2">
                        ...
                        <a class="btn btn-outline-secondary btn-sm"
                            href="<?php echo e(route('coordinator.reports.list-of-scholars.docx', ['semester_id' => $activeSemesterId])); ?>">
                                Download DOCX
                        </a>
                    </div>
