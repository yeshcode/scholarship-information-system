...
<div class="reports-wrap py-4">
    ...
    <div class="report-list">
        ...
        <div class="report-item">
            ...
            <div class="report-actions">
                <a class="btn btn-bisu btn-sm"
                   href="<?php echo e(route('coordinator.reports.scholarship-summary', ['semester_id' => $activeSemesterId])); ?>">
                    View Report
                </a>

                <a class="btn btn-outline-secondary btn-sm"
                   href="<?php echo e(route('coordinator.reports.scholarship-summary.pdf', ['semester_id' => $activeSemesterId])); ?>">
                    Download PDF
                </a>
            </div>
        </div>
