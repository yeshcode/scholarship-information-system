        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('coordinator.reports.list-of-scholars')); ?>"
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('coordinator.reports.summary-of-scholarships')); ?>"
                       class="btn btn-primary btn-sm">
                        View / Print
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\scholarship-information\resources\views/coordinator/reports/index.blade.php ENDPATH**/ ?>