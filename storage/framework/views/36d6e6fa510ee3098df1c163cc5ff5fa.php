    ...
    <div class="row g-3 mb-3">
        <div class="col-12 col-md-6 col-lg-3">
            <div class="metric-card">
                ...
                <div class="metric-body">
                    ...
                    <div class="chip">+<?php echo e(number_format($recentScholars)); ?> this week</div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="metric-card">
                ...
                <div class="metric-body">
                    <div>
                        <div class="metric-num"><?php echo e(number_format($totalStudents)); ?></div>
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="metric-card">
                ...
                <div class="metric-body">
                    <div>
                        <div class="metric-num"><?php echo e(number_format($totalBatches)); ?></div>
                ...
                <div class="p-3">
                    <div class="row g-2">
                        <div class="col-12 col-md-4">
                            <a class="quick-link" href="<?php echo e(route('coordinator.enrollment-records')); ?>">
                                <span>Students Record</span><span>→</span>
                            </a>
                        </div>
                        <div class="col-12 col-md-4">
                            <a class="quick-link" href="<?php echo e(route('coordinator.manage-stipend-releases')); ?>">
                                <span>Stipend Release Schedule</span><span>→</span>
                            </a>
                        </div>
                        <div class="col-12 col-md-4">
                            <a class="quick-link" href="<?php echo e(route('clusters.index')); ?>">
    ...
    <div class="panel">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $tableRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="ps-3 fw-bold"><?php echo e($r->scholarship_name); ?></td>
                            <td class="text-center fw-bold"><?php echo e(number_format($r->total)); ?></td>
                            <td>
                                <div class="progress" style="height: 10px;">
                                    <div class="progress-bar" role="progressbar" style="width: <?php echo e($r->percent); ?>%"
                                         aria-valuenow="<?php echo e($r->percent); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </td>
                            <td class="text-end pe-3 fw-bold"><?php echo e($r->percent); ?>%</td>
                        </tr>
