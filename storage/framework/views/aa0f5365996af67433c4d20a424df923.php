...
<div class="p-3">
    ...
    <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="mb-3">
        ...
        <?php if(request('college_id') || request('course_id') || request('year_level_id')): ?>
            <div class="mt-2">
                <a href="<?php echo e(route('admin.dashboard', ['page' => 'manage-users'])); ?>" class="btn btn-secondary btn-sm">
                    ✖ Clear Filters
                </a>
            </div>
        <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button"
                                    ...
                                    data-user='<?php echo json_encode($editPayload, 15, 512) ?>'>
                                    Edit
                                </button>
                                ...
                                <button type="button"
                                    ...
                                    data-user='<?php echo json_encode($deletePayload, 15, 512) ?>'>
                                    Delete
                                </button>
                            </td>
                        </tr>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <select name="year_level_id" id="e_year_level_id" class="form-select form-select-sm">
                                            <option value="">Select</option>
                                            <?php $__currentLoopData = $yearLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($level->id); ?>"><?php echo e($level->year_level_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const oldCollegeId = <?php echo json_encode(old('college_id'), 15, 512) ?>;
  const oldCourseId  = <?php echo json_encode(old('course_id'), 15, 512) ?>;
  if(oldCollegeId){
  ...
  editModalEl?.addEventListener('show.bs.modal', async function (event) {
    ...
    form.action = `<?php echo e(url('/admin/users')); ?>/${user.id}`;
...
</script><?php /**PATH C:\xampp\htdocs\scholarship-information\resources\views/super-admin/users.blade.php ENDPATH**/ ?>