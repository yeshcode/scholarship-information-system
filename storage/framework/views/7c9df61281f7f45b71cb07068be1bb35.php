    ...
    <div class="report-title">LIST OF SCHOLARS AND GRANTEES</div>
        ...
        <div class="text-center" style="margin-top:2px; margin-bottom:10px; line-height:1.2;">
            ...
            <div style="text-decoration: underline; text-underline-offset: 3px;">
                <?php echo e($semester ? ($semester->term . ', AY ' . $semester->academic_year) : 'Semester not set'); ?>

            </div>
        </div>

        <div class="meta-line">
            <span><strong>Total:</strong> <?php echo e($scholars->count()); ?></span>
    </div>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $scholars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo e($mi); ?></td>

                    <td class="text-center"><?php echo e($sex); ?></td>
                    <td><?php echo e($u->course->course_name ?? '-'); ?></td>
                    <td class="text-center"><?php echo e($yearLevelLabel); ?></td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\scholarship-information\resources\views/coordinator/reports/list-of-scholars.blade.php ENDPATH**/ ?>