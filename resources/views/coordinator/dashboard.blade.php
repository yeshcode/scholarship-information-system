    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="metric-card">
                ...
                <div class="metric-body">
                    <div>
                        <div class="metric-num">{{ number_format($topCourseTotal) }}</div>
                        <div class="metric-note">{{ $topCourseName }}</div>
                    </div>
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="metric-card">
                ...
                <div class="metric-body">
                    ...
                    <div class="chip">{{ $growthTrendLabel }}</div>
                </div>
            </div>
        </div>
    </div>
