{{-- resources/views/super-admin/colleges-delete.blade.php --}}
@extends('layouts.app')
...
<div class="min-h-screen flex items-center justify-center bg-gray-100">  {{-- Centers the content like a small modal --}}
    <div class="max-w-sm mx-auto bg-white shadow-lg rounded-lg p-6">  {{-- Smaller width for compactness --}}
        ...
        <p class="text-gray-700 mb-4">Are you sure you want to delete this college? This action cannot be undone.</p>

        <div class="bg-gray-50 p-4 rounded-lg mb-4 border">
            <h2 class="font-semibold text-gray-800">{{ $college->college_name }}</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.colleges.destroy', $college->id) }}">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('admin.dashboard', ['page' => 'colleges']) }}" class="inline-flex items-center text-gray-600 hover:text-gray-800 font-medium py-2 px-4 transition duration-200 text-sm">
