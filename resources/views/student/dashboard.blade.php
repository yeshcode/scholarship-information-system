...
<div class="container-fluid container-xl py-4">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="text-muted small">
                                    ...
                                    {{ $studentYearLevel ?? 'Year Level: N/A' }}
                                </div>
                            </div>

                            <span class="badge rounded-pill px-3 py-2
                                {{ ($isScholar ?? false) ? 'bg-success-subtle text-success border border-success-subtle' : 'bg-light text-dark border' }}">
                                <i class="bi bi-patch-check-fill me-1"></i>
                                {{ ($isScholar ?? false) ? 'Scholar' : 'Student' }}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 rounded-4 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">{{ $announcementsCount ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 rounded-4 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">{{ $unreadCount ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 rounded-4 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">{{ $questionsCount ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 rounded-4 shadow-sm h-100">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="fs-4 fw-bold">{{ $scholarshipsCount ?? 0 }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('student.announcements') }}" class="text-decoration-none">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('student.scholarships.index') }}" class="text-decoration-none">
                <div class="card border-0 rounded-4 shadow-sm h-100 dash-card">
                    <div class="card-body d-flex gap-3">
                        <div class="icon-bubble bisu-soft">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('questions.create') }}" class="text-decoration-none">
                <div class="card border-0 rounded-4 shadow-sm h-100 dash-card">
                    <div class="card-body d-flex gap-3">
                        <div class="icon-bubble bisu-soft">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('student.stipend-history') }}" class="text-decoration-none">
                <div class="card border-0 rounded-4 shadow-sm h-100 dash-card">
                    <div class="card-body d-flex gap-3">
                        <div class="icon-bubble bisu-soft">
        ...
        <div class="col-12 col-lg-6">
            <div class="card border-0 rounded-4 shadow-sm h-100 panel-body-fixed">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('student.announcements') }}" class="small text-decoration-none">
                    ...
                    <div class="panel-items">
                        @forelse($announcements ?? [] as $a)
                            <div class="p-3 rounded-4 border mb-2">
                                <div class="fw-semibold wrap-anywhere">{{ $a->title }}</div>
                                <div class="text-muted small mt-1">
                                    {{ \Illuminate\Support\Str::limit($a->description, 110) }}
                                </div>
        ...
        <div class="col-12 col-lg-3">
            <div class="card border-0 rounded-4 shadow-sm h-100 panel-body-fixed">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('questions.my') }}" class="small text-decoration-none">
                        View all <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
                        ...
                        @forelse($myRecentQuestions ?? [] as $q)
                            ...
                            <div class="p-3 rounded-4 border mb-2">
                                <div class="fw-semibold small wrap-anywhere">
                                    {{ \Illuminate\Support\Str::limit($q->question ?? $q->question_text ?? $q->message ?? 'No question text found.', 85) }}
                                </div>
                                <span class="badge rounded-pill mt-2 {{ $badgeClass }}">
                                    {{ $label }}
                                </span>
                            </div>
                        @empty
        ...
        <div class="col-12 col-lg-3">
            <div class="card border-0 rounded-4 shadow-sm h-100 panel-body-fixed">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('student.notifications') }}" class="small text-decoration-none">
                        View all
                        @if(($unreadCount ?? 0) > 0)
    ...
    <div class="panel-items">
        @forelse($notifications ?? [] as $notification)
            ...
            <a href="{{ $openUrl }}" class="text-decoration-none text-dark">
                <div class="p-3 rounded-4 border mb-2 notif-card {{ $isUnread ? 'bg-primary-subtle border-primary-subtle' : '' }}">
